...
| 9 | Summary search — a way TO a student, not a filter of the table: pick a result and it opens her day view, carrying the summary's PICKED date (as the row tap already does) | 3 | NOT BUILT — with 8 |
