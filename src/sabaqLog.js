...
const FIELDS = ['surah', 'ayah_from', 'ayah_to', 'tajweed_tags', 'line_count', 'page_count'];
...
export async function handleSaveSabaq(request, env, auth) {
  ...
  const values = [body.surah ?? null, body.ayah_from ?? null, body.ayah_to ?? null, body.tajweed_tags ?? null, body.line_count ?? null, body.page_count ?? null];
