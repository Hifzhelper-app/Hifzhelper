...
check('V4.2.11 pins remain on untouched files while later-edited files carry their current last-edit header',
  ...
  && /^\/\* Hifzhelper build 4\.2\.15\.1 \| css\/detail-pages\.css \*\//.test(css)
  ...
  && /^\/\* Hifzhelper build 4\.2\.15\.1 \| js\/maktabAttendancePage\.js \*\//.test(page)
  && /^\/\* Hifzhelper build 4\.2\.15\.1 \| js\/sw\.js \*\//.test(sw));
