...
check('Maktab Summary keeps its explicit green Attendance button; V4.2.15.4 removes the redundant reverse button from Attendance',
...
check('Student and Attendance headers both expose chevron sort controls',
  /data-sort-key="name"[\s\S]{0,900}mkregister-sort-chevron/.test(attendance)
  && /data-sort-key="attendance"[\s\S]{0,900}mkregister-sort-chevron/.test(attendance)
