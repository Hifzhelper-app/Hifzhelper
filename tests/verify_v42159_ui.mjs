#!/usr/bin/env node
// V4.2.15.10 — transparent Maktab Log action rail + unified selector polish +
...
check('served asset versions and service-worker cache are aligned on V4.2.15.10',
...
check('last-edit headers changed only in product files actually edited for V4.2.15.10',
